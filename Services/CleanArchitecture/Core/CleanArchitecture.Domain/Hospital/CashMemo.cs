...
namespace Merchandising.Domain.Hospital
{
    public partial class CashMemo
    {
        public CashMemo()
        {
            DuePaymentPharmacies = new HashSet<DuePaymentPharmacy>();
        }
        ...
        public string TranxNo { get; set; }
        public int? NoOfPrint { get; set; }

        public virtual ICollection<DuePaymentPharmacy> DuePaymentPharmacies { get; set; }
    }
}
